...
As best you can, it is a good idea to make your variable names informative (e.g. `x` doesn't mean anything, but `sandwich_price` is meaningful... if we're talking about the cost of sandwiches, that is..). All variables have to start with a letter.
...
log(81, 3) #the base = is not strictly nessecary
```
