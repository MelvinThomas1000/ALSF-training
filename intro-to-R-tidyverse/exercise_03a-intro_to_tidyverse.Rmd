...
file.exist(file.path("data", "GSE19578.tsv"))

genes_df<- readr::read_tsv(file.path("data", "GSE19578.tsv")
)
```
...
metadata <- readr::read_tsv(file.path("data", "metadata_GSE19578.tsv"))
```
...
metadata_clean<- dplyr::select(metadata, 
  "refinebio_accession_code", "refinebio_age", "refinebio_disease_stage"
)
```
